...
// Constants
const PRIVACY_LAST_UPDATED = 'July 3, 2025';
        ...
        <div className="text-center mb-12">
            ...
            <div className="mt-6 p-4 bg-amber-50 rounded-lg border border-amber-200">
                <p className="text-amber-800 text-sm">
                    Coffimer (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;, &quot;app&quot;)
                    protects and respects your privacy. This Privacy Policy explains what
                    information we collect, use, and share when you use the Coffimer app, and
                    describes your choices regarding this information.
                </p>
            </div>
        </div>
    );
                ...
                <div className="space-y-12">
                    ...
                    <section className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-lg">
                        ...
                        <ul className="list-disc list-inside space-y-2 mb-6">
                            ...
                            <ListItem>
                                <strong>Profile Information</strong>: Display name (optional)
                            </ListItem>
                            <ListItem>
                                <strong>User-Generated Content</strong>: Coffee recipes,
                                step-by-step instructions, YouTube links
                            </ListItem>
                        </ul>
                        ...
                        <ul className="list-disc list-inside space-y-2 mb-6">
                            <ListItem>
                                <strong>Usage Analytics Data</strong>: App usage patterns, screen
                                views, feature usage frequency
                            </ListItem>
                            <ListItem>
                                <strong>Recipe Interactions</strong>: Recipe views, likes, timer
                                usage records
                            </ListItem>
                            <ListItem>
                                <strong>Device Information</strong>: Operating system version, app
                                version, device type, language settings
                            </ListItem>
                            <ListItem>
                                <strong>Session Information</strong>: Login status, auto-login
                                settings, session tokens
                            </ListItem>
                            <ListItem>
                                <strong>Notification Tokens</strong>: Device identifiers for push
                        ...
                        <ul className="list-disc list-inside space-y-2 mb-6">
                            <ListItem>
                                <strong>Google Sign-In</strong>: Email address, basic profile
                                information (when using Google account)
                            </ListItem>
                            <ListItem>
                                <strong>Analytics Services</strong>: App usage statistics, error
                        ...
                        <ul className="list-disc list-inside space-y-2">
                            ...
                            <ListItem>
                                Biometric data (not stored; used only within device for
                    ...
                    <section className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-lg">
                        ...
                        <div className="mb-6">
                            ...
                            <ul className="list-disc list-inside space-y-1 text-amber-700 ml-4">
                                <li>
                                    <strong>Services Provided</strong>: Database, user
                                    authentication, real-time data synchronization
                                </li>
                                <li>
                                    <strong>Information Shared</strong>: Encrypted user data, recipe
                                    information
                                </li>
                                <li>
                                    <strong>Data Location</strong>: Cloud data centers (encrypted
                                    storage)
                                </li>
                                <li>
                        ...
                        <div className="mb-6">
                            ...
                            <ul className="list-disc list-inside space-y-1 text-amber-700 ml-4">
                                <li>
                                    <strong>Services Provided</strong>: Push notifications, app
                                    updates, error reporting
                                </li>
                                <li>
                                    <strong>Information Shared</strong>: Device tokens, app usage
                                    statistics, error logs
                                </li>
                                <li>
                                    <strong>Privacy Policy</strong>:{' '}
                                    <a
                        ...
                        <div className="mb-6">
                            ...
                            <ul className="list-disc list-inside space-y-1 text-amber-700 ml-4">
                                <li>
                                    <strong>Services Provided</strong>: App usage pattern analysis,
                                    user experience improvement
                                </li>
                                <li>
                                    <strong>Information Shared</strong>: Anonymized usage
                                    statistics, screen interaction data
                                </li>
                                <li>
                                    <strong>Privacy Policy</strong>:{' '}
                                    <a
                        ...
                        <div className="mb-6">
                            ...
                            <ul className="list-disc list-inside space-y-1 text-amber-700 ml-4">
                                <li>
                                    <strong>Services Provided</strong>: Feature usage statistics,
                                    app performance analysis
                                </li>
                                <li>
                                    <strong>Information Shared</strong>: Anonymized event data,
                                    usage patterns
                                </li>
                                <li>
                                    <strong>Privacy Policy</strong>:{' '}
                        ...
                        <div className="mb-6">
                            ...
                            <ul className="list-disc list-inside space-y-1 text-amber-700 ml-4">
                                <li>
                                    <strong>Services Provided</strong>: Social login functionality
                                </li>
                                <li>
                                    <strong>Information Shared</strong>: Email address, basic
                                    profile information (only with user consent)
                                </li>
                                <li>
                                    <strong>Privacy Policy</strong>:{' '}
                                    <a
                        ...
                        <ul className="list-disc list-inside space-y-2">
                            <ListItem>
                                <strong>Explicit Consent</strong>: When you have explicitly
                                consented
                            </ListItem>
                            <ListItem>
                                <strong>Legal Requirements</strong>: In response to court orders or
                                legal processes
                            </ListItem>
                            <ListItem>
                                <strong>Service Provision</strong>: Essential data sharing with
                                third-party service providers mentioned above
                            </ListItem>
                            <ListItem>
                                <strong>Safety Protection</strong>: When necessary to protect the
                    ...
                    <section className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-lg">
                        ...
                        <ul className="list-disc list-inside space-y-2 mb-6">
                            <ListItem>
                                <strong>Transmission Encryption</strong>: All data is transmitted
                                encrypted via HTTPS/TLS
                            </ListItem>
                            <ListItem>
                                <strong>Storage Encryption</strong>: Personal information is
                                encrypted in the database
                            </ListItem>
                            <ListItem>
                                <strong>Token Security</strong>: Authentication tokens are securely
                                stored in device Keychain(iOS)/Keystore(Android)
                            </ListItem>
                            <ListItem>
                                <strong>Access Control</strong>: Only authorized personnel with
                                necessary permissions have limited access rights
                            </ListItem>
                        </ul>
                        ...
                        <ul className="list-disc list-inside space-y-2">
                            <ListItem>
                                <strong>Regular Security Reviews</strong>: Regular inspection and
                                updates of security systems
                            </ListItem>
                            <ListItem>
                                <strong>Vulnerability Monitoring</strong>: Continuous monitoring for
                                security threats
                            </ListItem>
                            <ListItem>
                                <strong>Incident Response</strong>: Immediate response system in
                    ...
                    <section className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-lg">
                        ...
                        <ul className="list-disc list-inside space-y-2 mb-6">
                            ...
                            <ListItem>
                                Request explanation of personal information processing status
                            </ListItem>
                        </ul>
                        ...
                        <ul className="list-disc list-inside space-y-2 mb-6">
                            ...
                            <ListItem>
                                Direct modification of profile information (within the app)
                            </ListItem>
                        </ul>
                        ...
                        <ul className="list-disc list-inside space-y-2 mb-6">
                            <ListItem>
                                <strong>Account Deletion</strong>: Permanent account deletion
                                available in app settings
                            </ListItem>
                            <ListItem>
                                <strong>Data Deletion</strong>: Complete deletion of all related
                                data within 30 days of account deletion
                            </ListItem>
                            <ListItem>
                                <strong>Partial Deletion</strong>: Request selective deletion of
                        ...
                        <ul className="list-disc list-inside space-y-2 mb-6">
                            <ListItem>
                                Request restriction of personal information processing
                            </ListItem>
                            <ListItem>
                        ...
                        <ul className="list-disc list-inside space-y-2">
                            <ListItem>
                                <strong>Response Time</strong>: Initial response within 7 business
                                days, processing completed within 30 days
                            </ListItem>
                            <ListItem>
                                <strong>Identity Verification</strong>: Identity verification
                                process required when exercising rights
                            </ListItem>
                            <ListItem>
                                <strong>Fees</strong>: Exercise of personal information processing
                    ...
                    <section className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-lg">
                        ...
                        <ul className="list-disc list-inside space-y-2 mb-6">
                            ...
                            <ListItem>
                                <strong>Usage Records</strong>: Automatically deleted after maximum
                                2 years
                            </ListItem>
                            <ListItem>
                                <strong>Analytics Data</strong>: Retained for maximum 3 years after
                                anonymization
                            </ListItem>
                            <ListItem>
                                <strong>Legal Obligations</strong>: Compliance with minimum
                                retention periods required by applicable laws
                            </ListItem>
                        </ul>
                        ...
                        <ul className="list-disc list-inside space-y-2">
                            <ListItem>
                                <strong>Immediate Deletion</strong>: Immediate deletion of
                                personally identifiable information upon account deletion request
                            </ListItem>
                            <ListItem>
                                <strong>Complete Deletion</strong>: Complete deletion from all
                                systems and backups within 30 days
                            </ListItem>
                            <ListItem>
                                <strong>Irreversible</strong>: Deleted data cannot be recovered
                            </ListItem>
                        </ul>
                    </section>
                    ...
                    <section className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-lg">
                        ...
                        <ul className="list-disc list-inside space-y-2">
                            <ListItem>
                                Coffimer does not intentionally collect personal information from
                                children under 13 years of age
                            </ListItem>
                            <ListItem>
                                If we discover that information from children under 13 has been
                                collected, we will delete it immediately
                            </ListItem>
                            <ListItem>
                                Parents or guardians may inquire about their children&apos;s
                    ...
                    <section className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-lg">
                        ...
                        <ul className="list-disc list-inside space-y-2 mb-6">
                            <ListItem>
                                Your information may be stored in global data centers of Supabase
                                and other third-party services
                            </ListItem>
                            <ListItem>
                                All international transfers are made with appropriate security
                                measures
                            </ListItem>
                        </ul>
                        ...
                        <ul className="list-disc list-inside space-y-2">
                            <ListItem>
                                <strong>Adequacy Decisions</strong>: Transfers to countries with EU
                                adequacy decisions
                            </ListItem>
                            <ListItem>
                                <strong>Standard Contractual Clauses</strong>: Contractual
                                safeguards ensuring appropriate level of protection
                            </ListItem>
                            <ListItem>
                                <strong>Certification Mechanisms</strong>: Compliance with
                    ...
                    <section className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-lg">
                        ...
                        <ul className="list-disc list-inside space-y-2 mb-6">
                            <ListItem>
                                <strong>Timer Notifications</strong>: Step-by-step coffee brewing
                                alerts
                            </ListItem>
                            <ListItem>
                                <strong>Service Notifications</strong>: Important updates and policy
                                changes
                            </ListItem>
                            <ListItem>
                                <strong>Control Methods</strong>: Can be disabled anytime in app
                        ...
                        <ul className="list-disc list-inside space-y-2">
                            <ListItem>
                                <strong>Audio Playback</strong>: Notification sound playback when
                                timer completes
                            </ListItem>
                            <ListItem>
                                <strong>Notification Permission</strong>: Push notification delivery
                            </ListItem>
                            <ListItem>
                                <strong>Secure Storage</strong>: Safe storage of login information
                            </ListItem>
                            <ListItem>
                                <strong>Network Access</strong>: Data synchronization with server
                            </ListItem>
                        </ul>
                    </section>
                    ...
                    <section className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-lg">
                        ...
                        <ul className="list-disc list-inside space-y-2 mb-6">
                            <ListItem>
                                <strong>Session Tokens</strong>: Maintaining login status
                            </ListItem>
                            <ListItem>
                                <strong>Local Storage</strong>: App settings and cache data
                            </ListItem>
                            <ListItem>
                                <strong>Analytics Tools</strong>: Anonymous identifiers for usage
                                pattern analysis
                            </ListItem>
                        </ul>
                        ...
                        <ul className="list-disc list-inside space-y-2">
                            ...
                            <ListItem>
                                All related data is completely removed when account is deleted
                            </ListItem>
                        </ul>
                    </section>
                    ...
                    <section className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-lg">
                        ...
                        <ul className="list-disc list-inside space-y-2 mb-6">
                            <ListItem>
                                Advance notice at least 30 days before privacy policy changes
                            </ListItem>
                            <ListItem>
                                <strong>Notification Methods</strong>: In-app notifications, email
                                notices, policy page updates
                            </ListItem>
                            <ListItem>
                                <strong>Significant Changes</strong>: Separate consent process for
                                changes requiring user consent
                            </ListItem>
                        </ul>
                        ...
                        <ul className="list-disc list-inside space-y-2">
                            <ListItem>
                                Changes can be confirmed through the &quot;Last Updated&quot; date
                                at the top of the policy
                            </ListItem>
                            <ListItem>
                                Major changes will be announced separately in summary form
                            </ListItem>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="mt-8 bg-amber-50 rounded-lg p-6 border border-amber-200">
                            ...
                            <ul className="list-disc list-inside space-y-2 text-amber-700">
                                ...
                                <ListItem>
                                    Requests for exercising personal information rights
                                </ListItem>
                    ...
                    <section className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-lg">
                        ...
                        <p className="text-amber-800 mb-4">
                            This Privacy Policy has been written in compliance with the following
                            laws:
                        </p>
                        <ul className="list-disc list-inside space-y-2 mb-6">
                            <ListItem>
                                <strong>South Korea</strong>: Personal Information Protection Act,
                            ...
                            <ListItem>
                                <strong>Others</strong>: Relevant privacy protection laws in service
                                regions
                            </ListItem>
                        </ul>
                        ...
                        <ol className="list-decimal list-inside space-y-2 mb-6">
                            <li className="text-amber-700 pl-2">
                                <strong>First</strong>: Direct inquiry to developer (
                                {DEVELOPER_EMAIL})
                            </li>
                            <li className="text-amber-700 pl-2">
                                <strong>Second</strong>: Personal Information Protection Commission
                                Privacy Violation Report Center (privacy.go.kr)
                            </li>
                            <li className="text-amber-700 pl-2">
                        ...
                        <p className="text-amber-800">
                            We regularly conduct data protection impact assessments to review the
                            appropriateness and security of personal information processing.
                        </p>
                    </section>
                    ...
                    <div className="text-center py-8">
                        <div className="bg-amber-100 rounded-lg p-6 border border-amber-200">
                            <p className="text-amber-800 font-medium mb-4">
                                <strong>Effective Date</strong>: {PRIVACY_LAST_UPDATED}
                                <br />
                                <strong>Author</strong>: {DEVELOPER_NAME}
                                <br />
                                <strong>Version</strong>: v2.0
                            </p>
                            <p className="text-amber-800">
                                If you have any questions or concerns about this Privacy Policy,
                                please contact us at <strong>{DEVELOPER_EMAIL}</strong> anytime.
                            </p>
                        </div>
                    </div>
                </div>
