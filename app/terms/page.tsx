        ...
        <div className="text-center mb-12">
            ...
            <div className="mt-6 p-4 bg-amber-50 rounded-lg border border-amber-200">
                <p className="text-amber-800 text-sm">
                    Coffimer 앱("서비스")을 이용해 주셔서 감사합니다. 
                    본 이용약관은 {DEVELOPER_NAME}("당사", "개발자")이 제공하는 
                    Coffimer 모바일 애플리케이션의 이용 조건을 규정합니다.
                </p>
            </div>
        </div>
    );
...
function SubSectionTitle({ children }: SubSectionTitleProps) {
    return (
        <h3 className="text-xl font-semibold text-amber-800 mb-4 mt-8">
            {children}
        </h3>
    );
}
...
function ListItem({ children }: ListItemProps) {
    return (
        <li className="text-amber-700 mb-2 pl-2">
            {children}
        </li>
    );
}
    ...
    return (
        <div className="bg-gradient-to-r from-amber-100 to-orange-100 rounded-xl p-6 border border-amber-200">
            ...
            <div className="space-y-2 text-amber-700">
                <p><strong>이메일:</strong> {DEVELOPER_EMAIL}</p>
                <p><strong>개발자:</strong> {DEVELOPER_NAME}</p>
                ...
                <div className="space-y-12">
                    ...
                    <section className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-lg">
                        ...
                        <ul className="list-disc list-inside space-y-2 mb-6">
                            <ListItem>본 약관은 서비스를 다운로드하거나 사용하는 모든 사용자에게 적용됩니다</ListItem>
                            <ListItem>서비스 이용 시 본 약관에 동의한 것으로 간주됩니다</ListItem>
                            <ListItem>본 약관에 동의하지 않는 경우 서비스 이용을 중단해야 합니다</ListItem>
                        </ul>
                        
                        <SubSectionTitle>1.2 약관의 변경</SubSectionTitle>
                        <ul className="list-disc list-inside space-y-2">
                            <ListItem>당사는 필요 시 본 약관을 변경할 수 있습니다</ListItem>
                            <ListItem>변경된 약관은 앱 내 공지 후 7일 후 효력이 발생합니다</ListItem>
                            <ListItem>변경 후 계속 이용 시 변경된 약관에 동의한 것으로 간주됩니다</ListItem>
                        </ul>
                    </section>
                    ...
                    <section className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-lg">
                        ...
                        <p className="text-amber-800 mb-4">Coffimer는 다음과 같은 기능을 제공합니다:</p>
                        <ul className="list-disc list-inside space-y-2 mb-6">
                    ...
                    <section className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-lg">
                        ...
                        <ul className="list-disc list-inside space-y-2 mb-6">
                            <ListItem>서비스의 모든 콘텐츠는 당사 또는 라이선서의 지적재산권으로 보호됩니다</ListItem>
                            <ListItem>사용자는 개인적, 비상업적 목적으로만 서비스를 이용할 수 있습니다</ListItem>
                            <ListItem>당사의 사전 서면 동의 없이 콘텐츠를 복제, 배포할 수 없습니다</ListItem>
                        </ul>
                        
                        <SubSectionTitle>4.2 사용자 콘텐츠</SubSectionTitle>
                        <ul className="list-disc list-inside space-y-2">
                            <ListItem>사용자가 생성한 레시피 등의 콘텐츠는 사용자의 소유입니다</ListItem>
                            <ListItem>당사는 서비스 제공을 위해 필요한 범위에서만 사용자 콘텐츠를 이용합니다</ListItem>
                    ...
                    <section className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-lg">
                        ...
                        <p className="text-amber-800 mb-4">다음의 경우 서비스 이용을 제한하거나 중단할 수 있습니다:</p>
                        <ul className="list-disc list-inside space-y-2 mb-6">
                        ...
                        <ul className="list-disc list-inside space-y-2">
                            ...
                            <ListItem>당사는 약관 위반 시 사전 통지 후 계정을 해지할 수 있습니다</ListItem>
                            <ListItem>계정 해지 시 모든 데이터는 개인정보 보호정책에 따라 처리됩니다</ListItem>
                        </ul>
                    </section>
                    ...
                    <section className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-lg">
                        ...
                        <ul className="list-disc list-inside space-y-2 mb-6">
                            ...
                            <ListItem>인터넷 연결 장애나 기기 문제로 인한 서비스 중단에 대해 책임지지 않습니다</ListItem>
                        </ul>
                        
                        <SubSectionTitle>6.2 손해 배상의 제한</SubSectionTitle>
                        <ul className="list-disc list-inside space-y-2">
                            <ListItem>서비스 이용으로 인한 직접적, 간접적 손해에 대해 책임을 지지 않습니다</ListItem>
                            <ListItem>손해 배상 책임은 관련 법령이 허용하는 최대 범위로 제한됩니다</ListItem>
                            <ListItem>커피 추출 과정에서 발생하는 사고나 손상에 대해 책임지지 않습니다</ListItem>
                        </ul>
                    </section>
                    ...
                    <section className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-lg">
                        ...
                        <ul className="list-disc list-inside space-y-2">
                            <ListItem>개인정보 처리에 관해서는 별도의 개인정보 보호정책이 적용됩니다</ListItem>
                            <ListItem>개인정보 보호정책은 본 약관의 일부로 간주됩니다</ListItem>
                            <ListItem>서비스 이용 시 개인정보 보호정책에도 동의한 것으로 간주됩니다</ListItem>
                        </ul>
                    </section>
                    ...
                    <section className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-lg">
                        ...
                        <ul className="list-disc list-inside space-y-2 mb-6">
                            ...
                            <ListItem>국제 사용자의 경우 현지 법률도 함께 고려될 수 있습니다</ListItem>
                        </ul>
                        
                        <SubSectionTitle>8.2 분쟁 해결 절차</SubSectionTitle>
                        <ol className="list-decimal list-inside space-y-2 mb-6">
                            <li className="text-amber-700 pl-2"><strong>직접 협의</strong>: 먼저 개발자와 직접 소통을 시도합니다</li>
                            <li className="text-amber-700 pl-2"><strong>조정</strong>: 협의가 불가능한 경우 조정 기관을 통한 해결을 시도합니다</li>
                            <li className="text-amber-700 pl-2"><strong>중재 또는 소송</strong>: 최후의 수단으로 중재나 법정 소송을 진행합니다</li>
                        </ol>
                        
                        <SubSectionTitle>8.3 관할법원</SubSectionTitle>
                        <ul className="list-disc list-inside space-y-2">
                            <ListItem>소송이 필요한 경우 대한민국 서울중앙지방법원을 제1심 관할법원으로 합니다</ListItem>
                        </ul>
                    </section>
                    ...
                    <section className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-lg">
                        ...
                        <ul className="list-disc list-inside space-y-2 mb-6">
                            <ListItem>본 약관의 일부가 무효로 판정되어도 나머지 조항은 유효합니다</ListItem>
                            <ListItem>무효인 조항은 유효한 범위 내에서 최대한 그 의도를 살려 해석됩니다</ListItem>
                        </ul>
                        ...
                        <ul className="list-disc list-inside space-y-2">
                            <ListItem>당사가 약관 위반에 대해 즉시 조치하지 않는다고 해서 권리를 포기한 것은 아닙니다</ListItem>
                        </ul>
                    </section>
